...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ocuco.Hydra.WebMVC21.V2.Data.Entities.ArtOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ocuco.Hydra.WebMVC21.V2.Data.Entities.ArtOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ocuco.Hydra.WebMVC21.V2.Data.Entities.ArtProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ocuco.Hydra.WebMVC21.V2.Data.Entities.ArtOrderItem", b =>
                {
                    b.HasOne("Ocuco.Hydra.WebMVC21.V2.Data.Entities.ArtOrder", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId");

                    b.HasOne("Ocuco.Hydra.WebMVC21.V2.Data.Entities.ArtProduct", "Product")
                        .WithMany()
